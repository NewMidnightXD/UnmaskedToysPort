...
noteTweenAlpha("makinglifeeasy", 1, 0.25, value1, 'linear')
noteTweenAlpha("makinglifeeasy1", 3, 0.25, value1, 'linear')
noteTweenAlpha("makinglifeeasy2", 2, 0.25, value1, 'linear')
noteTweenAlpha("makinglifeeasy4", 0, 0.25, value1, 'linear')
end
if value2 == 'mid' then
